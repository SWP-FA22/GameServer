  ...
  <body class="bg-grey-200">
    ...
    <div class="flex flex-col items-center justify-center">
      ...
      <div
          ...
          <c:forEach items="${requestScope.listbypid}" var="listbypid">
      ...
      >
        <div class="flex item-center justify-end">
          ...
          <div
            class="icon-trash cursor-pointer w-5 mr-2 transform hover:text-purple-500 hover:scale-110"
          >
