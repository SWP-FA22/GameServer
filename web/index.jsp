...
>>>>>>> 4dc01b43aa760590de1a3439b3b6ab3bd3c50e60
                    ...
                    <div class="flex justify-center">
                        <div
                            ...
                            <div class="p-6">
                                <img
                                    class="mx-auto mb-4"
                                    src="<%= request.getContextPath()%>/assets/img/game-store.svg"
                                    width="150"
                                    alt="logo"
                                    />
                    ...
                    <div class="flex justify-center">
                        <div
                            ...
                            <div class="p-6">
                                <img
                                    class="mx-auto mb-4"
                                    src="<%= request.getContextPath()%>/assets/img/game.svg"
                                    width="150"
                                    alt="logo"
                                    />
                    ...
                    <div class="flex justify-center">
                        <div
                            ...
                            <div class="p-6">
                                <img
                                    class="mx-auto mb-4"
                                    src="<%= request.getContextPath()%>/assets/img/connect.svg"
                                    width="150"
                                    alt="logo"
                                    />
                                <h5 class="text-gray-900 text-xl font-medium mb-2">
        ...
        <div class="relative">
            <img
                src="<%= request.getContextPath()%>/assets/img/wallpaperflare.com_wallpaper.jpg"
        ...
        <footer class="text-center lg:text-left bg-[#F8F9FA] text-gray-600">
                ...
                <div class="grid grid-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                    <div class="">
                        <h6
                            ...
                            >
                            <img src="<%= request.getContextPath()%>/assets/img/logo.png" width="150" />
                        </h6>
                        <p class="text-sm">
                            VIETNAM ENTERTAINMENT AND E-sports JOINT STOCK COMPANY Head office
                            address: 29th floor, Lotte Center Hanoi building, number 54, Lieu
                            Giai street, Cong Vi Ward, Ba Dinh District, Hanoi City, Vietnam.
                            Phone: 024 73053939
                        </p>
                    </div>
                    ...
                    <div class="md:ml-28">
                        ...
                        <p class="mb-4">
                            <a href="#!" class="text-gray-600">Mobile</a>
                        </p>
                        <p class="mb-4">
                            <a href="#!" class="text-gray-600">PC</a>
                        </p>
                    </div>
                    <div class="">
                        <h6
            ...
            <!-- <div class="text-center p-6 bg-[#F8F9FA]">
